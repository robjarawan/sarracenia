    ...
    * a dictionary indexed by some sort of key to prevent duplicate
    ...
    def __init__(self, options, name):
        ...
        if self.o.queueName == None: 
            ...
            # if match:
            #     logger.warn( f"Detected possible autogenerated queueName {self.o.queueName}; should set it in config to avoid issues" )
    ...
    def on_housekeeping(self):
        ...
        # housekeeping file becomes new retry
            ...
            logger.info( f"Number of messages in retry list {N}" )
